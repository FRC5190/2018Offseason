...
public class SplineGenerator {
    ...
    private static void getSegmentArc(Spline s, List<Pose2dWithCurvature> rv, double t0, double t1, double maxDx,
        ...
        Pose2d transformation = new Pose2d(new Translation2d(p0, p1).rotateBy(r0.getInverse()), r1.rotateBy(r0.getInverse()));
        Twist2d twist = Twist2d.Companion.fromPose(transformation);
